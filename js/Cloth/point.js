...
ClothEngine.Point.prototype = function (x, y) {
    'use strict';
    ...
    this.resolve_constraints = function () {
    ...
    this.attach = function (point) {
        this.constraints.push(
            new ClothEngine.Line(this, point)
        );
    };

    this.remove_constraint = function (constraint) {
        this.constraints.splice(this.constraints.indexOf(constraint), 1);
    };

    this.add_force = function (x, y) {
        this.vx += x;
        this.vy += y;
    };

    this.pin = function (pinx, piny) {
        this.pin_x = pinx;
        this.pin_y = piny;
    };
    return new ClothEngine.Point();
};
